...
如果你在 Java 9 之后使用 `-XX:+PrintGC` 和 `-XX:+PrintGCDetails`，大概会看到这样的提示：
...
- [Java - Your Application Launcher - Dev.java](https://dev.java/learn/jvm/tools/core/java/)
- [The `java` Command](https://docs.oracle.com/en/java/javase/20/docs/specs/man/java.html)
