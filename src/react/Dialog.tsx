...
export function useDialog({ initialOpen = false, open: controlledOpen, onOpenChange: setControlledOpen }: DialogOptions = {}) {
...
>(function DialogContent(props, propRef) {
  ...
  return (
    <FloatingPortal>
      <FloatingOverlay className="bg-slate-800/80 grid place-items-center" lockScroll>
